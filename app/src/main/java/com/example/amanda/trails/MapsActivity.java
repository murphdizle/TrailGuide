...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chosenTrail = (Trail) getIntent().getParcelableExtra("trail");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng trailLocation = new LatLng(chosenTrail.getLatitude(), chosenTrail.getLongitude());
        mMap.addMarker(new MarkerOptions().position(trailLocation).title("Marker in Sydney"));
